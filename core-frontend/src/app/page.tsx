    ...
    <section>
      <div className={styles.wrapper}>
        ...
        <div>
          ...
          <br />
          <br />
          Основная миссия нашей компании - показать и рассказать людям о
          новинках и инновационных решениях в сфере сжатого воздуха, а так же
          дать понять, что брендовое оборудование может быть доступно для
          каждого.
          <br />
          <br />
          Мы начинали свой бизнес с продажи итальянского пневматического
          инструмента FASCO и крепежных изделий польского бренда EMES и
          постепенно расширяли наш ассортимент. <br />
          <br />
