  ...
  <section class="home d-flex flex-column align-center">
    ...
    <div class="home-wrapper fill-width mt-4 mb-4 pl-3 pr-3">
      ...
      <p>
        ...
        EZ-FASTEN, SENCO и BOSTITCH. Данные компании являются лидерами по
        производству: скобозабивных, штифтозабивных, шпилькозабивных,
        гвоздезабивных, специальных и упаковочных пистолетов. Эти компании не
        раз доказали всему миру надежность, приемлемую цену и ремонтопригодность
        производимого ими инструмента.
        <br /><br />
